...
namespace XAmple.Specs.Support
{
    ...
    {
        private readonly dynamic m_Instance;
        ...
        public PropertyDescriptorCollection GetProperties(Attribute[] attributes)
        {
            return new PropertyDescriptorCollection(
                ((IDictionary<string, object>)m_Instance).Keys
                                                         .Select(x => new ExpandoObjectPropertyDescriptor(((IDictionary<string, object>)m_Instance), x))
                                                         .ToArray());
        }
